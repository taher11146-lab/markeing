...
def draw_premium_chrome_line(ax, x, y, colors, lw=20):
    ...
    lc = LineCollection(segments, cmap=cmap, norm=norm, linewidth=lw, capstyle='round', zorder=3)
...
plt.savefig('P8_Marketing_Masterpiece_Logo.png', dpi=400, bbox_inches='tight', pad_inches=0.2, facecolor=fig.get_facecolor(), edgecolor='none')
plt.show()
